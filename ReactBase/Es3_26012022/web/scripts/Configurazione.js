    ...
    render() {
        return (
           <div className="Configurazione">
                ...
                <input type="number" id="Larghezza" name="Larghezza" onChange={this.aggiorna} min="8"/><br/>
                <label for="Lunghezza">Lunghezza: </label>
                <input type="number" id="Lunghezza" name="Lunghezza" onChange={this.aggiorna} min="8"/><br/>
                <label for="Lanci">Numero lanci: </label>
                <input type="number" id="Lanci" name="Lanci" onChange={this.aggiorna} min="1"/><br/>
                <button id="gen" onClick={this.props.genera}>Genera</button>
            </div>
        );
    }
}