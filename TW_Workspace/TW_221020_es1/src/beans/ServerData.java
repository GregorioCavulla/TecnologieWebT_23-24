...
public class ServerData implements Serializable {
	...
	public boolean creatTavolo(String table) {
		for(Tavolo t : this.getTavoli()) {
			if(t.getNome().equals(table)) {
				return false;
			}
		}
		Tavolo tavolo = new Tavolo();
		tavolo.setNome(table);
		this.addTavolo(tavolo);
		return true;
	}
	...
	public Tavolo getTavolo(String nome) {
