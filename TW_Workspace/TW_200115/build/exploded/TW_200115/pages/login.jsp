	...
	<div class="login-container">
		...
		<form class="login-form" action="../login" method="post">
			<label for="username">Username:</label> <input type="text"
				...
				id="password" name="password" required> <label>Gruppo:</label><select id="gruppo" name="gruppo">
				<option value="0" id="gruppo" name="gruppo">0</option>
				<option value="1" id="gruppo" name="gruppo">1</option>
				<option value="2" id="gruppo" name="gruppo">2</option>
				<option value="3" id="gruppo" name="gruppo">3</option>
				<option value="4" id="gruppo" name="gruppo">4</option>
				<option value="5" id="gruppo" name="gruppo">5</option>
			</select>
